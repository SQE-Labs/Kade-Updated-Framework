...
public class GiftCardDashboardPage extends BaseTest {
    ...
    public By memoField = By.cssSelector("textarea[name='memo']");
    ...
    public By newBillButton = By.cssSelector("button.fs-p15.btn.btn-outline-dark");
    public By amtToConsume = By.cssSelector("div.mb-3>label~input[name='amount']");
    public By confirmBtbn = By.cssSelector("div.mb-4.fs-p50");
    public By notificationIcon= By.cssSelector("li.ms-lg-2>a.nav-link>i");
    ...
    public static void LoginAsNewCustomer(String username, String password) {
    ...
    public void verifyNullAmountValidationMsg() {
        ...
        click(saveConfiguration);
        Assert.assertEquals(getText(cardAmountValidationMsg), Constants.ValidationMsg);
    }
    ...
    public void verifyCustomerPopUp() {
        ...
        waitForElementToBeInteractable(customerField, 10000);
        clickElementByJS(customerField);
        Assert.assertEquals(getText(customerTitleText), Constants.customerPopupTitle);
