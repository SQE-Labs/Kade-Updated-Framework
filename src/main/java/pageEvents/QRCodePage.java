...
public class QRCodePage extends BaseTest {
    ...
    By enterSuggAmount = By.xpath("//input[@name='items[0].price']");
    ...
    By saveBtn = By.xpath("(//button[text()='Save'])[4]");
    By OffToggleBtn = By.xpath("//i[@class='far fa-toggle-on custom-check-on text-danger']");
    By flexibleAmtSaveBtn = By.xpath("(//button[text()='Save'])[1]");
    ...
    public By monthHeader = By.xpath("(//th[@class='month'])[1]");
    By currentDate = By.xpath("//td[contains(@class,'today active start-date')]");
    ...
    public By linkNotAvailableTxt = By.xpath("//div[normalize-space()='This link is not available.']");
    ...
    public void clickOnViewLink() {
        waitForElementToBeVisible(viewLink, 15);
        click(viewLink);
    }
    ...
    public void clickOnSaveBtnOnEditPayment() {
        waitForElementToBeVisible(saveBtnOnEditPayment, 20);
    ...
    public void clickOneditContent() {
        scrollToElement(editContent);
        waitForElementToBeVisible(editContent, 15);
        click(editContent);
    }
    ...
    public void clickOncontent() {
        ...
        waitForElementToBeVisible(content, 20);
        click(content);
        waitForElementToBeVisible(contentPage, 20);
    ...
    public void clickOnsaveBtnContentPage() {
        scrollToElement(saveBtnContentPage);
        click(saveBtnContentPage);
    }

    public void clickOnsaveBtn() {
        waitForElementToBeVisible(saveBtn, 20);
    ...
    public void clickOnAddBtn() {
        waitForElementToBeVisible(addBtn, 20);
    ...
    public void selectfieldType() {
        click(fieldType);
        waitForElementToBeVisible(selectValue, 20);
        click(selectValue);
    }
    ...
    public void clickOnEditIcon() {
        waitForElementToBeVisible(editIcon, 20);
    ...
    public void clickOndeleteIcon() {
        waitForElementToBeVisible(deleteIcon, 20);
        click(deleteIcon);
    }
    ...
    public void clickOnflexibleAmtSaveBtn() {
        scrollToElement(flexibleAmtSaveBtn);
        waitForElementToBeVisible(flexibleAmtSaveBtn, 20);
        click(flexibleAmtSaveBtn);
    }

    public void clickOnToggleBtn() {
        waitForElementToBeVisible(OffToggleBtn, 20);
        if (isElementDisplayed(OffToggleBtn)) {
            click(OffToggleBtn);
        } else {
            Log.info("Toggle button is off");
        }

    }

    public void clickOnEyeIcon() {
        waitForElementToBeVisible(eyeIcon,15);
    ...
    public void clickEyeIcon() {
        waitForElementToBeVisible(eyeSuccessIcon, 15);
    ...
    public void uploadImageInStoreLogo() {
    ...
    public void clickOnCountinueBtn() {
        waitForElementToBeVisible(countinueBtn, 15);
    ...
    public void typesOfQrCodes() {
        selectStore();
        Assert.assertTrue(isElementDisplayed(directPaySection));
        Assert.assertTrue(isElementDisplayed(contactScreenSection));
        Assert.assertTrue(isElementDisplayed(customerPermissionSection));
    }
    ...
    public void directPaySect(String amount) {
        ...
        ClickOnDirectPaySec();
        staticWait(5000);
        Assert.assertTrue(isElementDisplayed(directPayHeader));
        Assert.assertTrue(isElementDisplayed(copyIcon));
        WebElement element = getDriver().findElement(By.xpath("//h6[text()='Direct Pay']/..//button"));
        element.click();
        String ele = element.getAttribute("data-content");
        Assert.assertTrue(isElementDisplayed(downloadIcon));
        Assert.assertTrue(isElementDisplayed(viewLinkIcon));
        clickOnCrsIcon();
        ...
        staticWait(3000);
        clickOnPayNowBtn();
        Assert.assertTrue(isElementDisplayed(payNow));
        waitForElementToBeVisible(enterAmt, 10);
        Assert.assertTrue(isElementDisplayed(enterAmt));
        enterAmount(amount);
        clickOnUpdateBtn();
    }
    ...
    public void contactScreenSect() {
        ...
        Assert.assertTrue(isElementDisplayed(contactScreenHeader));
        Assert.assertTrue(isElementDisplayed(contactScreenCopyIcon));
        WebElement element = getDriver().findElement(By.xpath("//h6[text()='Contact Screen']/..//button"));
        element.click();
        String ele = element.getAttribute("data-content");
        Assert.assertTrue(isElementDisplayed(contactScreenViewIcon));
        Assert.assertTrue(isElementDisplayed(contactScreenDownloadIcon));
        clickOnCrsIcon();
        ((JavascriptExecutor) getDriver()).executeScript("window.open()");
        openNewWindow();
        ...
        getDriver().get(ele);
        staticWait(3000);
        Assert.assertTrue(isElementDisplayed(storeName));
        Assert.assertTrue(isElementDisplayed(authorizePayment));
    }

    public void custPermSect() {
        selectStore();
        ClickOncustPerSec();
        Assert.assertTrue(isElementDisplayed(cusPerHeader));
        Assert.assertTrue(isElementDisplayed(cusPerCopyIcon));
        WebElement element = getDriver().findElement(By.xpath("//h6[text()='Customer permissions']/..//button"));
        element.click();
        String ele = element.getAttribute("data-content");
        Assert.assertTrue(isElementDisplayed(cusPerViewIcon));
        Assert.assertTrue(isElementDisplayed(cusPerDownloadIcon));
        clickOnCrsIcon();
        ((JavascriptExecutor) getDriver()).executeScript("window.open()");
        openNewWindow();
    ...
    public void donationQRCode(String titleTxt, String enterSuggAmountTxt, String titleFieldTxt, String enterTitleField) throws AWTException {
        ...
        waitForElementToBeVisible(validationMsgOnEditPayment, 15);
        String validationMsg = getText(validationMsgOnEditPayment);
        Assert.assertEquals(validationMsg, "Please review the highlighted field(s)");

        scrollToTopOfPage();
        waitForElementToBeVisible(titleFieldLength, 15);
        String Attvalue = getAttribute(titleFieldLength, "maxlength");
        Assert.assertEquals(Attvalue, "200");
        enterInDonationTitleField(titleTxt);
        String titleLength = getAttribute(DonationTitleField, "maxlength");
        Assert.assertEquals(titleLength, "100");
        // Enter description  In Suggested title fields.
        enterIntitleFieldLength(titleFieldTxt);
        // Enter amount In amounts fields.
    ...
    public void MakingQRCodeDonation() {
        selectStore();
        clickOnEyeIcon();
    }
}