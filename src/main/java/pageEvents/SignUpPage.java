...
public class SignUpPage extends BaseTest {
    ...
    public By crossIcon = By.xpath("(//button[@class='btn-close'])[1]");
    ...
    public By signInButton = By.xpath("//button[contains(@class,'w-100 max-20c rounded-3 p-2 py-3 rounded-lg bt')]");
    ...
    public By passwordFieldSignP = By.xpath("//input[@name='password']");
    ...
    public void getBusinessAccount() {
        click(businessAccountButton);
    }

    public void getUseEmailLink() {
        click(useEmailLink);
    }

    public void getStartOverLink() {
        click(startOverLink);
    }

    public void getBusinessContinuebtn() {
        click(ContinueButtonBusiness);
    }

    public void getSignInBtn() {
        clickElementByJS(signInButton);
    }
    ...
    public void getValidationsOfPersonalAccountPage() {
        ...
        String actualMessage = getToolTipMessage(validation);
        softAssert.assertEquals(actualMessage, Constants.validation);
...
//    getReceiveTextEmailNotificationCheckBox();
        ...
        // tooltip message
        String actualToolTip = getToolTipMessage(validation);
        softAssert.assertEquals(actualToolTip, Constants.validation);
        ...
        String invalidEmailTooltip = getToolTipMessage(validation);
        softAssert.assertEquals(invalidEmailTooltip, Constants.validation);
